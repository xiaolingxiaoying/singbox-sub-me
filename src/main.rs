...
use clap::Parser;
use cli::args::{
    CertificateCommand, Cli, CliManagedProtocol, CliOverrideTarget, CliSubscriptionMode, Command,
    ConfigCommand, CredentialCommand, InstallOptions, OverrideCommand, ReleaseCommand,
    SingBoxCommand, SystemCommand, TrafficCommand,
};
use std::fs;
